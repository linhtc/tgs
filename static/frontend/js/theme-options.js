...
$(document).ready(function($) {
	...
	function interface(){
	    ...
	    // Skin Color value
	    var skin_color = "custom"; // blue (default), red , yellow , purple , blue , orange , purple , pink, cocoa , grey , custom
	    ...
	    $(".skin_color").attr("href", baseUrl+"static/default/frontend/css/" + skin_color + ".css?v=103");
    ...
    // Color changer
    $(".red").click(function(){
        $(".skin_color").attr("href", baseUrl+"static/default/frontend/css/red.css");
        // $(".logo_img").attr("src", "css/skins/red/logo.png");
        return false;
    });

    $(".blue").click(function(){
        $(".skin_color").attr("href", baseUrl+"static/default/frontend/css/blue.css");
        // $(".logo_img").attr("src", "css/skins/blue/logo.png");
        return false;
    });

    $(".yellow").click(function(){
        $(".skin_color").attr("href", baseUrl+"static/default/frontend/css/yellow.css");
        // $(".logo_img").attr("src", "css/skins/yellow/logo.png");
        return false;
    });

    $(".green").click(function(){
        $(".skin_color").attr("href", baseUrl+"static/default/frontend/css/green.css");
        // $(".logo_img").attr("src", "css/skins/green/logo.png");
        return false;
    });

    $(".orange").click(function(){
        $(".skin_color").attr("href", baseUrl+"static/default/frontend/css/orange.css");
        // $(".logo_img").attr("src", "css/skins/orange/logo.png");
        return false;
    });

    $(".purple").click(function(){
        $(".skin_color").attr("href", baseUrl+"static/default/frontend/css/purple.css");
        // $(".logo_img").attr("src", "css/skins/purple/logo.png");
        return false;
    });

    $(".pink").click(function(){
        $(".skin_color").attr("href", baseUrl+"static/default/frontend/css/pink.css");
        // $(".logo_img").attr("src", "css/skins/pink/logo.png");
        return false;
    });

    $(".cocoa").click(function(){
        $(".skin_color").attr("href", baseUrl+"static/default/frontend/css/cocoa.css");
        // $(".logo_img").attr("src", "css/skins/cocoa/logo.png");
        return false;
    });

    $(".suelte").click(function(){
        $(".skin_color").attr("href", baseUrl+"static/default/frontend/css/suelte.css");
        // $(".logo_img").attr("src", "css/skins/suelte/logo.png");
        return false;
    });

    $(".grey").click(function(){
        $(".skin_color").attr("href", baseUrl+"static/default/frontend/css/grey.css");
