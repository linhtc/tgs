    ...
    _infoTable = $('#infoTable').DataTable({
        ...
        fnInitComplete: function (oSettings) {
            setTimeout(function () {
                ...
                $('body').append('<a id="lightbox-anchor" href="" style="display: none;" data-lightbox="image-1" data-title="My caption">Image #1</a>');
                $("#infoTable tr").each(function(){
                    $(this).find("td:eq(6)").on('click', function(){
                        let href = _infoTable.cell(this).data();
                        console.log(href);
