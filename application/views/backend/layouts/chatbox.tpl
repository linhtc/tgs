{literal}
    <script type="text/javascript">
        function showHidechatbox(){
            let phoneIcon = '#coccoc-alo-phoneIcon';
            let t=document.getElementById("chatbox"),o=t.offsetWidth;
            t.opened?movechatbox(0,19-o):movechatbox(19-o,0),t.opened=!t.opened;
            t.opened?$(phoneIcon).hide():($(phoneIcon).show());
        }
        function movechatbox(t,o){
            let a=document.getElementById("chatbox"),e=Math.abs(t-o)>10?5:1,n=o>t?1:-1,i=t+e*n;
