        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header">
                    <h3 class="box-title">Sửa đổi module</h3>
                    ...
                    <div class="col-md-6">
                        <form>
                            <div class="form-group">
                                <label>Module</label>
                                <select id="slModule" name="slModule" class="form-control selectpicker params" notnull disabled>
                                    <option value=""></option>
...
<script>
    ...
    var objMdKey = '{$objMdKey}';
    var objMdFunc = parseJson('{json_encode($objMdFunc)}');
    function funcSubmit() {
    ...
    $(document).ready(function() {
        ...
        $('#slModule').selectpicker('val', objMdKey);
        $('#slFunction').selectpicker('val', objMdFunc);
        if(objMdKey == ''){
            toastr.warning('Không có data', 'Thông báo');
        }
    });
</script>