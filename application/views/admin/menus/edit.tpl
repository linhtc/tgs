                    ...
                    <div class="col-md-6">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control params" id="permission_key" name="permission_key" value="{$objPKey}" readonly >
                            </div>

                            <div class="form-group">
                                <label for="slFunction">Tên</label>
                                <input type="text" class="form-control params" id="permission_name" name="permission_name" value="{$objPName}" >
                            </div>
