        ...
        <div class="col-md-12">
            <div class="box box-success">
                ...
                <div class="box-body pad">
                    <div class="col-md-6">
                        <form action="{base_url()}admin/users/submit_change_password" method="post" id="change-password">
                            <div class="form-group">
                                <label>Mật khẩu hiện</label>
...
<script>
    ...
    function submitChangePassword() {
        ...
        if (password_1.length <= 5) {
            showAlert("Bạn cần nhập mật khẩu hiện tại");
            return;
        }

        if (password_2.length <= 5) {
            showAlert("Bạn cần nhập mật khẩu mới");
            return;
        }

        if (password_3.length <= 5) {
            showAlert("Bạn cần nhập mật khẩu mới lần hai");
            return;
        }
